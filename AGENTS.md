...
**Version:** `src/config.js` → `VERSION` (currently **10.15.2**)
...
| Avatar LOD | `avatarLod.js` + `avatarPoseSync.js` — multi-mixer walk, no hop |
| Grid / snap | `gridSystem.js` — 1u=1m · cell size · TransformControls snap |
