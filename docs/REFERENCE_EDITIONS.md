...
| **`tc-show`** | Script / export (lobby demo removed 10.20) | Runner, Hauler, Marshal, Mechanic, Span, Checkpoint — GLB+LOD, SFX |
...
Lobby **TC DEMO** was removed in 10.20. TC loaders (`tcShow`, `tcDrive`, `tcCircuit`) remain for export practice and scripts.
