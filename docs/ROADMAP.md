...
**Current:** 10.21.5 · **Live:** https://medicinalsheep.github.io/threshold/
...
| **10.15.2** | **Arrange mode** — select · drag · WASD · Q/E · R · snap · hub cycle |
| **10.15.3** | **Play as** — possess NPC/prop · TPS · K/Esc release · solo-only |
...
| **10.15.8** | **Anti-glitch** — lock HILOD · less UV/normal · kit/gallery freeze |
...
| **10.21.5** | **Walk + avatar gate** — idle/walk/run · TPS smoke · `avatar:audit` · lobby Grok opener |
...
| Training dataset growth | Waves 1–**8** + **origin.jsonl** · `train:mini -- --no-seed` / `--full --golden`; grow via EXPORT TRAINING PAIR → bootcamp:import |
| Skinned hero avatar | Starter bodies still procedural (`avatar:gen`); drop a Blender-rigged GLB via [BLENDER_AVATARS.md](BLENDER_AVATARS.md) |
