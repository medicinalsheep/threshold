...
**Current version:** see `src/config.js` · terminal grid default · quality ladder (light/kit/AI/materials/pad) · tiered agents (see [CAPABILITIES.md](CAPABILITIES.md) · [MATERIALS.md](MATERIALS.md) · [PHYSICS.md](PHYSICS.md))
