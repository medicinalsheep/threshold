...
**Status:** A+B · **E0–E5** · tier auto · multi-mat · floor B (path **C off** by default — thrash fix 10.14.4) · **light-compensated flats**  
**Product version:** see `src/config.js` → `VERSION` (10.15.x terminal baseline)  
